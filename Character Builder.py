...
ttk.Label(skillsframe_scholar, textvariable=versa_name, font=boldfont).grid(column=0, row=8, pady=(10,3), sticky=W)
versaframe.grid(column=0, row=9, columnspan=8, sticky=(N, W, E, S))
...
versa1_spin.grid(column=0, row=1, sticky=W)
